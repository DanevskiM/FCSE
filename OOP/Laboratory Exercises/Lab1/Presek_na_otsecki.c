/*Da se napise struktura koja kje opisuva otsecka vo dvodimenzionalen
prostor(dve tocki). Potoa da se napise funkcija koja kje proveruva dali
dve otsecki se secat.
#include<stdio.h>
#include<string.h>
#include<math.h>
...
int na_linija(otsecka o1, tocka t)
{
